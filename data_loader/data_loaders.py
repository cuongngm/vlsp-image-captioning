...
from albumentations import (HorizontalFlip, HueSaturationValue, RandomBrightnessContrast, Compose,
                            Normalize, ShiftScaleRotate)
from albumentations.pytorch import ToTensorV2
ImageFile.LOAD_TRUNCATED_IMAGES = True


def get_transforms():
    return Compose([HorizontalFlip(p=0.5), ShiftScaleRotate(p=0.5),
